...
**Yöntemin özeti:**
- **SBOX'taki doğrusallık:**: DES şifresindeki tek doğrusal olmayan, yani güvenliği sağlayan bölüm SBOX bölümüdür. Bu bölümdeki zafiyet kullanılarak, doğruluğu rastgeleden farklı bir doğrusal denklem oluşturulabilinir.
